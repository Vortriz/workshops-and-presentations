...
#draw-network((
  ...
  (from: "p4", to: "add1", type: "skip", mode: "flat", pos: 3,
    layers: ( (type: "conv", channels: ("K", "I/16"), widths: (0.3,), height: 2, depth: 3.5, name: "s16", show-relu: false), ) ),
  (from: "p3", to: "add2", type: "skip", mode: "flat", pos: 6,
    layers: ( (type: "conv", channels: ("K", "I/8"), widths: (0.3,), height: 2, depth: 3.5, name: "s16", show-relu: false), ))
))